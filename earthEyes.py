...
earth_file = os.path.join(directory, 'student.png')
earth_img = PIL.Image.open()
fig2, axes2 = plt.subplots(1, 2)
axes2[0].imshow(student_img)
axes2[1].imshow(student_small)
fig2.show()

# Paste earth into right eye and display
# Uses alpha from mask
student_img.paste(student_small, (1162, 966), mask=student_small) 
# Display
